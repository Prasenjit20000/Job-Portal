    ...
    return (
        <div className='text-center'>
            <div className='flex flex-col gap-5 my-18'>
                ...
                <h1 className='md:text-5xl text-3xl font-bold pt-4'>
                    Search, Apply & <br />
                ...
                <div className='flex justify-center'>
                    <div className=' md:w-[80%] flex justify-center'>
                        ...
                        <Button className='rounded-l-none rounded-r-md md:rounded-r-full w-12 bg-[#6A38C2] cursor-pointer' onClick={searchJobHandler}>
                            <Search />
                        </Button>
                    </div>
                </div>
